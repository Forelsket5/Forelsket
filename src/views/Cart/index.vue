              ...
              <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                  ...
                  <div class="mt-4 sm:mt-0 sm:pr-9">
                    ...
                    <select :id="`quantity-${productIdx}`" :name="`quantity-${productIdx}`" class="max-w-full rounded-md border border-gray-300 py-1.5 text-left text-base/5 font-medium text-gray-700 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
...
const products = [
  {
    ...
    inStock: true,
    size: 'Large',
    imageSrc: 'https://tailwindui.starxg.com/plus/img/ecommerce-images/shopping-cart-page-01-product-01.jpg',
  ...
  },
  {
    ...
    leadTime: '3–4 weeks',
    size: 'Large',
    imageSrc: 'https://tailwindui.starxg.com/plus/img/ecommerce-images/shopping-cart-page-01-product-02.jpg',
  ...
  },
  {
    ...
    color: 'White',
    inStock: true,
    imageSrc: 'https://tailwindui.starxg.com/plus/img/ecommerce-images/shopping-cart-page-01-product-03.jpg',
...
const relatedProducts = [
  {
    ...
    href: '#',
    imageSrc: 'https://tailwindui.starxg.com/plus/img/ecommerce-images/shopping-cart-page-01-related-product-01.jpg',
